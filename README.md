...
| Fonts        | Self-hosted [Zodiak](https://www.fontshare.com/fonts/zodiak) (fetched by `scripts/fetch-fonts.ts`) + [IBM Plex Sans](https://fonts.google.com/specimen/IBM+Plex+Sans) via Fontsource |
